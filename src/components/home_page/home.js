		...
		<Card className="space">
			...
			<CardBody>
				...
				<CardSubtitle tag="h6" className="mb-2 text-muted">
					<span className="fa fa-users fa-lg follower-icon" /> {space.followers}{" "}
					followers
				</CardSubtitle>
				<div className="row mt-4">
					...
					<Button className="col-12 mt-3" color="danger">
...
>>>>>>> c85e118afeddbf5e45d2e2b1647a32431ba24f8f
...
=======
		...
		const SuggestedSpaces = this.state.suggestedSpaces.map((space) => {
			return (
				<div
					className="col-12 col-lg-3 col-md-6 col-sm-6 mt-1 mb-4"
					key={space.id}
				>
...
=======
			if (this.state.filter === "Latest") {
				...
				renderQuestions = MenuUnanswered;
			else renderQuestions = SuggestedSpaces;
>>>>>>> c85e118afeddbf5e45d2e2b1647a32431ba24f8f
                    ...
                    <div>
                        <section className="new_section">
                            <div className='container col-12 home-questions'>
                                    ...
                                    <div id='all-questions-id' className="row mt-4 justify-content-center">
                                            {renderQuestions}
                                    </div>
                                </div>
                        </section>
										...
										<div className="row ml-1 mt-2 mr-1">
											<Nav className="col-12 " tabs>
												...
												<NavItem className="mb-4 filters">
													<NavLink
														href="#"
														active={this.state.suggetsedActive}
														onClick={() => this.onSuggestedSelect()}
													>
														Recommended Spaces
													</NavLink>
												</NavItem>

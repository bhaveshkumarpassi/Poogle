                    ...
                    <Col xs={4} className="profile__header__column">
                        <Row>
                            <div className="user__posts__details">
                                <Row>
                                    <span className="user__icon"><HiOutlineUserGroup/><span className="icon__title"> {user.upvotes} upvotes</span></span> 
                                </Row>
                                <Row>
                                    <span className="user__icon"><RiQuestionAnswerFill/><span className="icon__title">{user.answers} answers</span></span>
                                </Row>
                                <Row>
                                    <span className="user__icon"><FaBlog/> <span className="icon__title">{user.blogs} blogs</span></span>
                                </Row>
                                <Row>
                                    <span className="user__icon"><FaQuestionCircle/><span className="icon__title">{user.questions} questions</span></span>
                                </Row>
                            </div>
                        </Row>

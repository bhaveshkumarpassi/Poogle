...
const RenderTags = ({ blogDemand }) =>
  blogDemand.tagNames.map((tag) => {
    return (
          ...
          <div className="col-12 col-sm-8">
            <ListGroupItemHeading className="blogDemand-heading">
              ...
              {auth.userId === blogDemand.author._id ? (
                <Button
                  color="danger"
                  onClick={() => deleteBlogDemand(blogDemand._id)}
                >
...
class BlogDemands extends Component {
  ...
  handleSubmit(event) {
    ...
    if (isValid) {
      ...
      for (var i = 0; i < len; i++) {
        ...
        if (
          this.props.auth.interests.indexOf(this.state.category[i].value) > -1
        )
          flag = true;
      }
      ...
      if (flag) {
        ...
        this.notify(
          "Atleast one category should be in your followed spaces list . you can follow required space to add this demand!!"
        );
      }
    }
  }
  ...
  render() {
    var count = -1;
    const MenuDate = this.props.blogDemands
      ...
      <div className="container blogDemands">
        ...
        <div className="row">
          <div className="container category-div ">
            <h4 className="row all-blogDemand-heading justify-content-center">
              BlogDemands
            </h4>
          ...
          <ModalBody>
            <div className="container">
              <Form.Group controlId="formBasicEmail">
                <Form.Label>
                  <span className="form__icon"></span>Title
                </Form.Label>
                <input
                  name="title"
              ...
              <Form.Group controlId="formBasicDropdown">
                <Form.Label>
                  <span className="form__icon"></span>Choose Category
                </Form.Label>
                <div>
                  <Select
                    isMulti

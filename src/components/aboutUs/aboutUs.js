...
import { Breadcrumb, BreadcrumbItem, Card, CardBody, CardTitle, CardSubtitle, CardImg,
         } from 'reactstrap';
    ...
    return(
        <div className='container about'>
            ...
            <div className='row justify-content-center'>
                <h2 className='dev-heading'><span className='fa fa-lg fa-code mr-4' />Developers</h2>
            </div>
            <div className='row justify-content-center dev-content'>
                ...
                <FadeTransform
                    ...
                    transformProps={{
                        ...
                        <CardBody>
                            <CardTitle tag="h5" className='dev-name'>Bhavesh Kumar</CardTitle>
                        </CardBody>
                ...
                <FadeTransform
                    ...
                    transformProps={{
                        ...
                        <Card className='space dev-card'>
                        <CardBody>
                            <CardTitle tag="h5" className='dev-name'>Nisha</CardTitle>
                        </CardBody>
                ...
                <FadeTransform
                    ...
                    transformProps={{
                        ...
                        <Card className='space dev-card'>
                        <CardBody>
                            <CardTitle tag="h5" className='dev-name'>Utkarsh Goel</CardTitle>
                        </CardBody>
